...
from .views import (
    ...
    cycle_detail,
    cycle_self_study,
    cycle_self_study_ai_draft,
    cycle_checklist,
    cycle_background,
    cycle_background_llama_extract,
    cycle_textbox_ai_extract,
    cycle_criterion1,
    cycle_criterion2,
    cycle_criterion4,
    cycle_criterion5,
...
urlpatterns = [
    ...
    path('programs/<int:program_id>/', program_detail),
    ...
    path('cycles/<int:cycle_id>/self-study/', cycle_self_study),
    path('cycles/<int:cycle_id>/self-study/ai-draft/', cycle_self_study_ai_draft),
    path('cycles/<int:cycle_id>/checklist/', cycle_checklist),
    path('cycles/<int:cycle_id>/background/', cycle_background),
    path('cycles/<int:cycle_id>/background/llama-extract/', cycle_background_llama_extract),
    path('cycles/<int:cycle_id>/textbox-ai-extract/', cycle_textbox_ai_extract),
    path('cycles/<int:cycle_id>/criterion1/', cycle_criterion1),
    path('cycles/<int:cycle_id>/criterion2/', cycle_criterion2),
    path('cycles/<int:cycle_id>/criterion4/', cycle_criterion4),
    path('cycles/<int:cycle_id>/criterion5/', cycle_criterion5),
    path('cycles/<int:cycle_id>/criterion6/', cycle_criterion6),
    path('cycles/<int:cycle_id>/appendixc/', cycle_appendixc),
    path('cycles/<int:cycle_id>/appendixd/', cycle_appendixd),
